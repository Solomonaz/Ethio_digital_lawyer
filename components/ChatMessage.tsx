      ...
      <div className={`flex ${isUser ? 'max-w-[85%] md:max-w-[75%] flex-row-reverse' : 'w-full max-w-full px-2'} items-start gap-4`}>
        ...
        <div className={`flex flex-col flex-1 ${isUser ? 'items-end' : 'items-start'}`}>
          ...
          <div className={`relative group py-2 text-sm md:text-base leading-7 ${isUser
            ? 'px-5 py-4 bg-gradient-to-br from-emerald-800 to-emerald-700 text-white rounded-2xl rounded-tr-sm shadow-lg shadow-emerald-500/10'
            : isError
            ...
            {!isUser && message.groundingSources && message.groundingSources.length > 0 && (
              <div className="mt-3 ml-1 p-4 bg-gradient-to-br from-stone-50 to-white rounded-xl border border-stone-100 w-full max-w-lg shadow-sm animate-fade-in">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-xs font-semibold text-stone-500 uppercase tracking-wider">{t('sources')}</p>
                </div>
                  ...
                  {message.groundingSources.map((source, idx) => (
                    <li key={idx}>
                      <a
                        ...
                        className="group flex items-center text-sm text-neutral-600 hover:text-emerald-600 transition-colors p-2 rounded-lg hover:bg-emerald-50"
                      >
                        <div className="w-5 h-5 rounded bg-stone-100 group-hover:bg-emerald-100 flex items-center justify-center mr-2 transition-colors">
                          <svg className="w-3 h-3 text-neutral-400 group-hover:text-emerald-500 transition-colors" fill="currentColor" viewBox="0 0 20 20">
